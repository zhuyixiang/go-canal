...
func NewRowsEvent(table *Table, action string, rows [][]interface{}) *RowsEvent {
	e := new(RowsEvent)
...
func GetPKValues(table *Table, row []interface{}) ([]interface{}, error) {
...
func GetColumnValue(table *Table, column string, row []interface{}) (interface{}, error) {
